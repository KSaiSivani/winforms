...
internal readonly struct MessageId
{
    ...
    internal string? MessageIdToString()
    {
        string? text = _id switch
        {
            ...
            PInvokeCore.WM_SYNCPAINT => "WM_SYNCPAINT",
            PInvokeCore.WM_NCXBUTTONDOWN => "WM_NCXBUTTONDOWN",
            PInvokeCore.WM_NCXBUTTONUP => "WM_NCXBUTTONUP",
            PInvokeCore.WM_NCXBUTTONDBLCLK => "WM_NCXBUTTONDBLCLK",
            ...
            // WM_UNICHAR shares the same value as WM_KEYLAST; only one can appear in the switch.
            ...
            PInvokeCore.WM_IME_REQUEST => "WM_IME_REQUEST",
            ...
            PInvokeCore.WM_WTSSESSION_CHANGE => "WM_WTSSESSION_CHANGE",
            ...
            PInvokeCore.WM_INPUT => "WM_INPUT",
            PInvokeCore.WM_INPUT_DEVICE_CHANGE => "WM_INPUT_DEVICE_CHANGE",
            ...
            PInvokeCore.WM_DDE_INITIATE => "WM_DDE_INITIATE",
            PInvokeCore.WM_DDE_TERMINATE => "WM_DDE_TERMINATE",
            PInvokeCore.WM_DDE_ADVISE => "WM_DDE_ADVISE",
            PInvokeCore.WM_DDE_UNADVISE => "WM_DDE_UNADVISE",
            PInvokeCore.WM_DDE_ACK => "WM_DDE_ACK",
            PInvokeCore.WM_DDE_DATA => "WM_DDE_DATA",
            PInvokeCore.WM_DDE_REQUEST => "WM_DDE_REQUEST",
            PInvokeCore.WM_DDE_POKE => "WM_DDE_POKE",
            PInvokeCore.WM_DDE_EXECUTE => "WM_DDE_EXECUTE",
            PInvokeCore.WM_HOTKEY => "WM_HOTKEY",
            PInvokeCore.WM_PRINT => "WM_PRINT",
            PInvokeCore.WM_PRINTCLIENT => "WM_PRINTCLIENT",
            PInvokeCore.WM_APPCOMMAND => "WM_APPCOMMAND",
            PInvokeCore.WM_TOUCH => "WM_TOUCH",
            PInvokeCore.WM_TOUCHHITTESTING => "WM_TOUCHHITTESTING",
            PInvokeCore.WM_POINTERDEVICECHANGE => "WM_POINTERDEVICECHANGE",
            PInvokeCore.WM_POINTERDEVICEINRANGE => "WM_POINTERDEVICEINRANGE",
            PInvokeCore.WM_POINTERDEVICEOUTOFRANGE => "WM_POINTERDEVICEOUTOFRANGE",
            PInvokeCore.WM_NCPOINTERUPDATE => "WM_NCPOINTERUPDATE",
            PInvokeCore.WM_NCPOINTERDOWN => "WM_NCPOINTERDOWN",
            PInvokeCore.WM_NCPOINTERUP => "WM_NCPOINTERUP",
            PInvokeCore.WM_POINTERUPDATE => "WM_POINTERUPDATE",
            PInvokeCore.WM_POINTERDOWN => "WM_POINTERDOWN",
            PInvokeCore.WM_POINTERUP => "WM_POINTERUP",
            PInvokeCore.WM_POINTERENTER => "WM_POINTERENTER",
            PInvokeCore.WM_POINTERLEAVE => "WM_POINTERLEAVE",
            PInvokeCore.WM_POINTERACTIVATE => "WM_POINTERACTIVATE",
            PInvokeCore.WM_POINTERCAPTURECHANGED => "WM_POINTERCAPTURECHANGED",
            PInvokeCore.WM_POINTERWHEEL => "WM_POINTERWHEEL",
            PInvokeCore.WM_POINTERHWHEEL => "WM_POINTERHWHEEL",
            PInvokeCore.WM_POINTERROUTEDTO => "WM_POINTERROUTEDTO",
            PInvokeCore.WM_POINTERROUTEDAWAY => "WM_POINTERROUTEDAWAY",
            PInvokeCore.WM_POINTERROUTEDRELEASED => "WM_POINTERROUTEDRELEASED",
            ...
            PInvokeCore.WM_THEMECHANGED => "WM_THEMECHANGED",
            PInvokeCore.WM_CLIPBOARDUPDATE => "WM_CLIPBOARDUPDATE",
            PInvokeCore.WM_DWMCOMPOSITIONCHANGED => "WM_DWMCOMPOSITIONCHANGED",
            PInvokeCore.WM_DWMNCRENDERINGCHANGED => "WM_DWMNCRENDERINGCHANGED",
            PInvokeCore.WM_DWMCOLORIZATIONCOLORCHANGED => "WM_DWMCOLORIZATIONCOLORCHANGED",
            PInvokeCore.WM_DWMWINDOWMAXIMIZEDCHANGE => "WM_DWMWINDOWMAXIMIZEDCHANGE",
            PInvokeCore.WM_DWMSENDICONICTHUMBNAIL => "WM_DWMSENDICONICTHUMBNAIL",
            PInvokeCore.WM_DWMSENDICONICLIVEPREVIEWBITMAP => "WM_DWMSENDICONICLIVEPREVIEWBITMAP",
            PInvokeCore.WM_GETTITLEBARINFOEX => "WM_GETTITLEBARINFOEX",
            PInvokeCore.WM_DPICHANGED => "WM_DPICHANGED",
            PInvokeCore.WM_DPICHANGED_BEFOREPARENT => "WM_DPICHANGED_BEFOREPARENT",
            PInvokeCore.WM_DPICHANGED_AFTERPARENT => "WM_DPICHANGED_AFTERPARENT",
            PInvokeCore.WM_GETDPISCALEDSIZE => "WM_GETDPISCALEDSIZE",
