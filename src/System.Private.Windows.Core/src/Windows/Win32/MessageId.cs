...
internal readonly struct MessageId
{
    ...
    internal string? MessageIdToString()
    {
        string? text = _id switch
        {
            ...
            PInvokeCore.WM_UNICHAR => "WM_UNICHAR",
            ...
            PInvokeCore.WM_GESTURE => "WM_GESTURE",
            PInvokeCore.WM_GESTURENOTIFY => "WM_GESTURENOTIFY",
            PInvokeCore.WM_MENUSELECT => "WM_MENUSELECT",
            PInvokeCore.WM_MENUCHAR => "WM_MENUCHAR",
            PInvokeCore.WM_ENTERIDLE => "WM_ENTERIDLE",
            PInvokeCore.WM_MENURBUTTONUP => "WM_MENURBUTTONUP",
            PInvokeCore.WM_MENUDRAG => "WM_MENUDRAG",
            PInvokeCore.WM_MENUGETOBJECT => "WM_MENUGETOBJECT",
            PInvokeCore.WM_UNINITMENUPOPUP => "WM_UNINITMENUPOPUP",
            PInvokeCore.WM_MENUCOMMAND => "WM_MENUCOMMAND",
            PInvokeCore.WM_CHANGEUISTATE => "WM_CHANGEUISTATE",
            PInvokeCore.WM_UPDATEUISTATE => "WM_UPDATEUISTATE",
            PInvokeCore.WM_QUERYUISTATE => "WM_QUERYUISTATE",
            ...
            PInvokeCore.WM_XBUTTONDOWN => "WM_XBUTTONDOWN",
            PInvokeCore.WM_XBUTTONUP => "WM_XBUTTONUP",
            PInvokeCore.WM_XBUTTONDBLCLK => "WM_XBUTTONDBLCLK",
            PInvokeCore.WM_MOUSEHWHEEL => "WM_MOUSEHWHEEL",
            ...
            PInvokeCore.WM_NCMOUSEHOVER => "WM_NCMOUSEHOVER",
            PInvokeCore.WM_NCMOUSELEAVE => "WM_NCMOUSELEAVE",
