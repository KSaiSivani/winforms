...
internal readonly struct MessageId
{
    ...
    internal string? MessageIdToString()
    {
        string? text = _id switch
        {
            ...
            PInvokeCore.WM_KEYFIRST => "WM_KEYFIRST",
            ...
            PInvokeCore.WM_SETTINGCHANGE => "WM_SETTINGCHANGE",
            ...
            PInvokeCore.WM_TABLET_FIRST => "WM_TABLET_FIRST",
            PInvokeCore.WM_TABLET_LAST => "WM_TABLET_LAST",
            PInvokeCore.WM_TOOLTIPDISMISS => "WM_TOOLTIPDISMISS",
            PInvokeCore.WM_INTERCEPTED_WINDOW_ACTION => "WM_INTERCEPTED_WINDOW_ACTION",
            PInvokeCore.WM_CLOAKED_STATE_CHANGED => "WM_CLOAKED_STATE_CHANGED",
            PInvokeCore.WM_IME_REQUEST => "WM_IME_REQUEST",
            PInvokeCore.WM_IME_KEYLAST => "WM_IME_KEYLAST",
