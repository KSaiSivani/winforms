...
public class FileDialogTests
{
    ...
    [Fact]
    public void FileDialog_InitialDirectory_EditorAttribute_IsInitialDirectoryEditor()
    {
        ...
        PropertyInfo property = typeof(FileDialog).GetProperty(nameof(FileDialog.InitialDirectory));
